import {is_address, is_hex, labels_from_dns_encoded, safe_str} from './utils.js';
...
export async function handleCCIPRead({sender, request, getRecord, signingKey, resolver, maxDepth = 1, ttlSec = 60} = {}) {
